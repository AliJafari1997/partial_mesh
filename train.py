...
if __name__ == "__main__":
    ...
    create_dir("/content/drive/MyDrive/files_partial_mesh")

    train_path = "/content/drive/MyDrive/clinic_augmented/train/"
    valid_path = "/content/drive/MyDrive/clinic_augmented/valid/" 
    ...
    model_path='/content/drive/MyDrive/files_partial_mesh/model.h5'
    batch_size = 6
    epochs = 100
    lr = 1e-4
    ...
    callbacks = [
        ...
        CSVLogger("/content/drive/MyDrive/files_partial_mesh/data.csv"),
        TensorBoard(),
